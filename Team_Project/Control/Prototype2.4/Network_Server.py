...
class ClientImgProcess( Process ):
    ...
    def insertDB( self, imgdata, product):
        ...
        with conn:
            cursor = conn.cursor()
            cursor.execute( 'INSERT INTO Quantity(type, cal, count, date, time, img) VALUES(?, ?, ?, ?, ?, ?)', data )
    ...
    def run( self ):
        ...
        while True:
            ...
            """ image data protocol """
            getlength1 = self.client_sock.recv( 16 )
            ...
            getlength2 = self.client_sock.recv( 16 )
