...
class SensorReceptionProcess( Process ): # Process 상속
    def __init__( self, ip, port ):
        Process.__init__( self, name = "SensorReceptionProcess" ) # 프로세스 초기화 작업
...
class ClientProcess( Process ): # 프로세스 상속
...
def main():
    sensorManageProcess = SensorReceptionProcess( '192.168.0.125', 9000 )
